...
_sewa.expiredCheck(xavior, sewa)
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await xavior.setStatus(`${'XznBotz-MD 🤖'} | Runtime 🌥️: ${runtime(uptime)}`)
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case 'sc': {
                anu = `*Kalian Bisa Cek Ke Github Saya:*
https://github/XzenzBotz

*Link Group Bot :*
https://chat.whatsapp.com/HcFK1AOcPNJ0OB2vX81jue`
let btn = [{
                                urlButton: {
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                xavior.sendListMsg(m.chat, `Please select the menu you want to change!`, 'XznBot-MD', `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 https://wa.me/62895609803131?text=Permisi%20kak%20saya%20mau%20sewa%20bot
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 https://wa.me/62895609803131?text=Permisi%20kak%20saya%20mau%20order%20jadi%20bot
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
                ...
                listMessage :{
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "👤 〉ɞ  Only Owner Command",
										"description": "_Mau dibuatin bot? Chat WA_",
										"rowId": `${prefix}ownermenu`
									},
									{
										"title": "👥 〉ɞ  Group Command",
										"description": "_Menampilkan Group Menu_",
										"rowId": `${prefix}groupmenu`
									},
									{
										"title": "📰 〉ɞ  Webzone Command",
										"description": "_Menampilkan fitur webzone_",
										"rowId": `${prefix}webzonemenu`
									},
									{
										"title": "📤 〉ɞ  Downloader Command",
										"description": "_Menampilkan fitur donwload_",
										"rowId": `${prefix}downloadermenu`
									},
									{
										"title": "🔎 〉ɞ  Search Command",
										"description": "_Mencari sesuatu yang gk penting_",
										"rowId": `${prefix}searchmenu`
									},
									{
										"title": "🔮 〉ɞ  Other Command",
										"description": "_Menampilkan Random Menu_",
										"rowId": `${prefix}randommenu`
									},
									{
										"title": "📸 〉ɞ  Teks Pro Command",
										"description": "_Untuk Membuat Logo Menggunakan Bot_",
										"rowId": `${prefix}textpromenu`
									},
									{
										"title": "🖼️ 〉ɞ  Photo Oxy Command",
										"description": "_Menampilkan fitur photo oxy_",
										"rowId": `${prefix}photooxymenu`
									},
									{
										"title": "🎨 〉ɞ  Ephoto Command",
										"description": "_Membuat logo menggunakan bot_",
										"rowId": `${prefix}ephotomenu`
									},
									{
										"title": "🎮 〉ɞ  Games Command",
										"description": "_Fitur untuk bermain dengan bot_",
										"rowId": `${prefix}funmenu`
									},
									{
										"title": "🌟 〉ɞ  Primbon Command",
										"description": "_Ramalan masa kini_",
										"rowId": `${prefix}primbonmenu`
									},
									{
										"title": "⛓️ 〉ɞ  Converter Command",
										"description": "_Mengkonversi sesuatu dengan bot_",
										"rowId": `${prefix}convertmenu`
									},
									{
										"title": "🔓 〉ɞ  Main Command",
										"description": "_Menampilkan informasi bot_",
										"rowId": `${prefix}mainmenu`
									},
									{
										"title": "📂 〉ɞ  Database Command",
										"description": "_Menyimpan sesuatu di database bot_",
										"rowId": `${prefix}databasemenu`
									},
									{
										"title": "🖥️ 〉ɞ  Anonymous Command",
										"description": "_Untuk mencari teman lewat bot_",
										"rowId": `${prefix}anonymousmenu`
									},
									{
										"title": "🕌 〉ɞ  Islamic Command",
										"description": "_Menampilkan fitur islami_",
										"rowId": `${prefix}islamicmenu`
									},
									{
										"title": "🎙️ 〉ɞ  Voice Changer",
										"description": "_Fitur untuk mengubah suara audio / vn_",
										...
										},
							{
								...
								"rows": [
									{
										"title": "Pembuat Bot",
										"description": "_Pembuat Botnya Cuy_ 😉",
										"rowId": `${prefix}owner`
									}
								]
							},
							{
								...
								"rows": [
									{
										"title": "Sewabot",
										"description": "_Biar Bisa Masukin Ke Grup Lu_ 😋",
							...
							},
							{
								...
								"rows": [
									{
										"title": "Contributor 💌",
										"description": "_Menampilkan Ungkapan Terima Kasih_ 💞",
...
│ ➪ ⚙️ Mode : ${xavior.public ? 'Public' : 'Self'}
...
let btn = [{
            ...
            case 'menu': case 'help': case '?': {
                anu = `${ucapanWaktu} Kak👋\n\nI Am ${global.namabot}, Bot Ini Sedang Tahap Proses.\n\n${global.namabot} Diciptakan Untuk Memudahkan Para Manusia Ataupun Bahan Untuk Yang Lagi Bosen Bingung Mau Ngapain🗿.\n\nDimohon Jika Menggunakan Bot Jangan Spam Beri Jeda Setidaknya 5 Detik Untuk Colldown Agar Bot Tidak Terjadi Masalah Atau Mengalami Lag, Patuhi Peraturan Penggunaan Bot Ini`
                let btn = [{
                                urlButton: {
                                    displayText: 'My Youtube️',
                                    url: 'https://youtube.com/channel/UCTan41uoODwP2uU0ORuoy3w'
...
*TERIMA KASIH YANG SUDAH MENDONASI😇*`
let btn = [{
                                urlButton: {
                                    displayText: 'My Youtube️',
                                    url: 'https://youtube.com/channel/UCTan41uoODwP2uU0ORuoy3w'
